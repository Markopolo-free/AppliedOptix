                ...
                programs.map(program => (
                  <tr key={program.id}>
                    ...
                    <td className="px-6 py-4 text-right">
                      <button onClick={() => handleOpenProgramModalForEdit(program)} className="font-medium text-primary-600 hover:text-primary-900 mr-2">Edit</button>
                      <button onClick={() => handleDeleteProgram(program.id)} className="font-medium text-red-600 hover:text-red-900">Delete</button>
                    </td>
                  </tr>
                ))
              )}
